    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ParcelDeliveryTrackingDBEntities>
    {
        ...
        protected override void Seed(ParcelDeliveryTrackingDBEntities context)
        {
            ...
            context.parcels.AddOrUpdate(p => p.ParcelId,
                    new Parcel() { ParcelId = 1, SenderID = 1, ReceiverID = 2, Weight = 5.50, ParcelStatus = "In Transit", DeliveryDate = new DateTime(2023, 10, 15, 09, 30, 00), AdditionalNotes = "Fragile item" },
                    ...
                    new Parcel() { ParcelId = 6, SenderID = 6, ReceiverID = 5, Weight = 4.50, ParcelStatus = "In Transit", DeliveryDate = new DateTime(2023, 11, 18, 10, 00, 00), AdditionalNotes = "Fragile item" },
