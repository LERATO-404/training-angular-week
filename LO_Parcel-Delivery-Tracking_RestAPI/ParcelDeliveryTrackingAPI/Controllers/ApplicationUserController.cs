...
namespace ParcelDeliveryTrackingAPI.Controllers
{
    ...
    public class ApplicationUserController : ControllerBase
    {
        ...
        public async Task<Object> PostApplicationUser(ApplicationUserModel model)
        {
            ...
            logger.Info("Post : /api/ApplicationUser/Register model:" + model.LastName);
            ...
            logger.Info("Post : /api/ApplicationUser/Register role:" + model.Role);
            try
            {
                if(model.Role == "Manager" || model.Role == "Driver")
                {
                    ...
                    logger.Info("Post Personnel : /api/ApplicationUser/Register role:" + model.Role);
                }
               ...
               /* if (model.Role == "User")
                ...
                if (result.Succeeded)
                {
                    ...
                    logger.Info("Post UserRole : /api/ApplicationUser/Register role:" + model.Role);
                }
